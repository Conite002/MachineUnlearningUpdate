...
class RandomForestUnlearner(DNNUnlearner):
    def __init__(self, train_data, test_data, voc, n_estimators=100):
        self.set_train_test_data(train_data, test_data)
        self.voc = voc
        self.model = RandomForestClassifier(n_estimators=n_estimators)
        self.model_param_str = 'RandomForest_n_estimators={}'.format(n_estimators)

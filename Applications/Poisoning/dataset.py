...
class Cifar10(object):
    dataset_dir = BASE_DIR/'train_test_data'/'Cifar10'
...
class Mnist(object):
    dataset_dir = BASE_DIR/'train_test_data'/'Mnist'
...
class FashionMnist(object):
    dataset_dir = BASE_DIR/'train_test_data'/'FashionMnist'
...
class SVHN(object):
    dataset_dir = BASE_DIR/'train_test_data'/'SVHN'
...
class GTSRB(object):
    dataset_dir = BASE_DIR/'train_test_data'/'GTSRB'

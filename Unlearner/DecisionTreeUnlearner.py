...
class DecisionTreeUnlearner(DNNUnlearner):
    def __init__(self, train_data, test_data, voc, max_depth=None):
        self.set_train_test_data(train_data, test_data)
        self.voc = voc
        self.model = DecisionTreeClassifier(max_depth=max_depth)
        self.model_param_str = 'DecisionTree_max_depth={}'.format(max_depth)
        self.theta = None

        
    def train_model(self, model_folder, **kwargs):
        self.model.fit(self.x_train, self.y_train)
        model_name = 'dt_model_{}.pkl'.format(self.model_param_str)
        report_name = 'dt_performance_{}.json'.format(self.model_param_str)

...
from Unlearner.GradientBoostingUnlearner import GradientBoostingUnlearner
...
class DPGBUnlearner(GradientBoostingUnlearner):
    def __init__(self, train_data, test_data, voc, sigma, lambda_, b=None, category_to_idx_dict=None):
